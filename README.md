...
- по описанию предметной области (из задания) создайте базу данных (demo) в phpMyAdmin с таблицами и связями,
...
1) измените название приложения на АИС "Журнал .." (в View/Basetemplate.php)
...
3) изменить название в меню на свое ("Услуги", "Рейсы", "Оценки" - в View/Basetemplate.php)
