...
1) подключите базу данных в DBStorage, const DNS = 'mysql:dbname=demo_service - измените на свое название БД (demo)
1) измените название приложения на АИС "Журнал услуг"
2) добавьте описание на главную: 
назначение приложения, что делать первым шагом (из описания предметной области задания)
3) изменить название в меню на "Услуги"
```
## Описание проекта
